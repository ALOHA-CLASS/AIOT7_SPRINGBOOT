...
public class OrderController {
  ...
  public void insert() {
    ...
    if( result != null ) {
      ...
      log.info("\"주문 등록 성공! (생성된 주문 번호 : {})", result.getNo());
    } else {
  ...
  public Orders input() {
    ...
    try {
      ...
      log.error("총 금액은 숫자 형식으로 입력해주세요!");
      e.printStackTrace();
      sc.nextLine();      // 🎈 예외 발생 시, 입력 버퍼 초기화
    }
